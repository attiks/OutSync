...
namespace OutSync.CurrentVersionWebService {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="CurrentVersionSoap", Namespace="http://tempuri.org/")]
    public partial class CurrentVersion : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public CurrentVersion() {
            this.Url = global::OutSync.Properties.Settings.Default.OutSync_CurrentVersionWebService_CurrentVersion;
        ...
        public string GetCurrentVersion(string installedVersion) {
        ...
        /// <remarks/>
        public void GetCurrentVersionAsync(string installedVersion) {
            this.GetCurrentVersionAsync(installedVersion, null);
        }
        
        /// <remarks/>
        public void GetCurrentVersionAsync(string installedVersion, object userState) {
            ...
            this.InvokeAsync("GetCurrentVersion", new object[] {
                        installedVersion}, this.GetCurrentVersionOperationCompleted, userState);
        }
